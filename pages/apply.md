...
{% for milestone in page.timeline %}
  <li class="timeline-step{% if milestone.deadline %} timeline-step-deadline{% endif %}">
    ...
    <ol class="usa-accordion">
      ...
      <li value="{{ step_counter }}" class="step {{ step }} {% if timeline_item_[0].becomes_inactive == true %} step-inactive timeline.button[disabled]{% endif %}" {% if timeline_item_[0].becomes_inactive == true %} style="color:red;" {% endif %}>
