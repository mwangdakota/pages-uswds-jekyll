...
- [{{ site.data.solicitations['PHASE_II'].title }}]({{ site.data.solicitations['PHASE_II'].url }}) (ARCHIVED)
- [{{ site.data.solicitations['STTR_PHASE_II'].title }}]({{ site.data.solicitations['STTR_PHASE_II'].url }}) (ARCHIVED)
