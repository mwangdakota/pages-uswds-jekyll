...
A team of nationally recognized leaders from academia, industry, the investment community, and public organizations participate in the [SBIR/STTR Subcommittee]({{ site.baseurl }}/sbir-sttr-subcommittee/) of the Directorate for Technology, Innovation and Partnerships Advisory Committee. Members guide NSF’s SBIR/STTR program on emerging industries and the evolution of the deep-technology startup community, participating in strategic initiatives to support the NSF’s mission of accelerating the growth of the nation’s innovation ecosystem.
