...
- [System for Award Management (SAM)](https://www.sam.gov/SAM/)
 ...
 When entering the organization’s TIN in SAM, ensure that the organization name matches the taxpayer name associated with your TIN. A mismatch of information can result in significant SAM registration activation delays.
  ...
  Any subrecipient(s) named in a proposal is also required to obtain a SAM.gov-issued Unique Entity ID (UEI) and register the organization with NSF. Subrecipient(s) named in the proposal, however, do not need to go through the full UEI registration in SAM.gov. Refer to the [Proposal & Award Policies & Procedures Guide](https://www.nsf.gov/publications/pub_summ.jsp?ods_key=nsf22001) (PAPPG) Chapter I.G.2. Details are as follows:       
